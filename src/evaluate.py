...
def main() -> None:
    ...
    lines.append("- Table: `reports/tables/phase5_auc_roc.csv`")
    lines.append("- Figure: `reports/figures/phase5_roc_curves.png`")
    ...
    lines.append(f"- Winner model artifact: `{Path(args.model).as_posix()}` ({type(model).__name__})")
    ...
    lines.append("- Feature table: `reports/tables/phase5_top_features.csv`")
